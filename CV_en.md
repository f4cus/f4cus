...
Hybrid Infrastructure & Cloud Security Engineer with 15+ years of experience operating regulated enterprise environments in banking and insurance sectors.
...
- Design and maintain CI/CD pipelines across hybrid infrastructure.
- Improve observability and monitoring coverage for production services.
- Standardize deployment workflows to reduce configuration drift.
- Evaluate tooling integration within architectural and compliance constraints.
...
### Micronet – Argentina  
**Business Owner** – June 2009 – June 2017

Provided IT infrastructure services and security consulting for small and medium enterprises.

---

## Selected Technical Projects

- Hybrid Agent Compliance Validation (Azure Arc / AMA readiness assessment)
- Windows Patching Governance Workflow
- Certificate Expiration Monitoring Dashboard
- Identity Detection Logic (KQL-based analysis)
- Infrastructure Observability Enhancements (Prometheus / Grafana)
...
- DevOps, Integration and Continuous Agility – Universidad Tecnológica Nacional  

---

## Education

- Senior Technician in Systems Analysis – 2014
